export const MESSAGES = {
  ...
  TOUR_ID_INVALID: 'Tour id is invalid',
  ...
  PAYMENT_STATUS_IS_INVALID: 'Payment status is invalid',
  PAYMENT_NOT_FOUND_OR_INVALID: 'Payment not found or invalid',
  CONFIRM_REFUND_SUCCESS: 'Confirm refund success',
  BOOKING_SUCCESS: 'Booking success',
  BOOKING_NOT_CANCELLED: 'Booking is not cancelled',
